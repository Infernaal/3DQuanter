$(function () {
    function AchievementsViewModel(parameters) {
        ...
        self.CALLS_TO_ACTION = [
            gettext(
                'Enjoying 3D Quanter? Looks like it! <a href="%(url)s" target="_blank" rel="noopener noreferer">It might be time to give something back then</a> - thank you!'
            ),
            gettext(
                'Getting value from 3D Quanter? <a href="%(url)s" target="_blank" rel="noopener noreferer">Then please consider supporting its sole maintainer with a donation</a> - thank you!'
            ),
            gettext(
